...
/**
 *  The user entity, now with added fields! Several are set to default for reasons.
 *  Players will have their 'playerCount' set to 99 by default, this will be for the purposes of searching.
 *  Everyone starts with an active account, however- as a DUngeon Master, if you fill all the seats at your table, your posting will expire.
 *  That said, you can update/reactivate at any time.
 */
