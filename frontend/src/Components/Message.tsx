...
/**
 * Message page, my hope is to take the user to the Game selection page, show a list of users, and then have a modal to a message page.
 * From there the user will be able to message, like or pass.
 */
	...
	return (
		<>
			...
			{submissionError == true && (
				<div
					className="flex items-center justify-center text-sm text-error-content w-4/5 mx-auto bg-error"
					role="alert"
				>
					<span className="font-medium">
						Danger alert! You tried to send one or more bad words!
					</span>
				</div>
			)}
